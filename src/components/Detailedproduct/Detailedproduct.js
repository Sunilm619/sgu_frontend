...
function Detailedproduct() {
    ...
    let { id } = useParams();
    let url = `http://localhost:4000/auth/products/${id}`;
                ...
                <div>
                    ...
                    {description && (
                        <div>
                            ...
                            <img src="https://cdn.shopify.com/s/files/1/0836/9845/0750/files/img_content_1.jpg?v=1699289844" alt="im" />
                    ...
                    <div className='d-flex overflow-auto' ref={onSaleRef}>
                        {filted.map((item) => (
                            <div key={item._id} className='card m-2'>
                                <img src={item.imgurl} alt={item.description} className='card-img-top' />
